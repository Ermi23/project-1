...
$query = "SELECT * FROM Pension_Return WHERE Datee = '" . $currentMonth . ' - ' . $currentYear . "'";
...
<?php
            if ($result->num_rows > 0) {
                ...
                <table class="table print-section">
                    <thead>
                        <tr>
                          <th>መለያ ኮድ</th>
                          <th> የቋሚ ሠራተኛው የግብር ከፋይ መለያ ቁጥር (TIN)</th>
                          <th>የሠራተኛው ስም የአባት ስምና የአያት ስም</th>
                          <th>የተቀጠሩበት ቀን</th>
                          <th>ደምወዝ</th>
                          <th>የሰራተኛው መዋጮ መጠን 7%/ብር/</th>
                          <th>የአሰሪው መዋጮ መጠን 11%/ብር/</th>
                          <th>በአሰሪው የሚገባ ጥቅል መዋጮ 18%/ብር/</th>
                          <th>የሠራተኛ ፊርማ</th>
                        </tr>
                    </thead>
                    <tbody>';
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $trs += $totalRowSum;
                        ...
                        $totalother += $other;
                        $plus=$employeePension + $companyPension;
                        $p += $plus;
                        $e += $employeePension;
                        $c += $companyPension;
                        ...
                        <td>' . number_format(floatval($companyPension), 2) . '</td>
                        <td>' . number_format(floatval($plus), 2) . '</td>
                        <td>  </td>
                    </tr>';
            ...
            FROM staff";
                ...
                echo '<tr>
                        ...
                        <th scope="col">' . number_format(floatval($e), 2) . '</th>
                        <th scope="col">' . number_format(floatval($c), 2) . '</th>
                        <th scope="col">' . number_format(floatval($p), 2) . '</th>
                        <th scope="col"> - </th>
                    </tr>
                    </tbody>
                    </table>';
                    ...
                    <form method="post" action="">
                        <input type="submit" class="btn btn-primary mx-2" id="saveButtonpr" name="saveButtonpr" value="Save To Database">
                        </form>';
                        ?>
...
<script>
    function exportToExcel() {
      ...
      XLSX.writeFile(wb, 'Pension_Return Report For <?php echo $currentMonth .' - '. $currentYear; ?>.xlsx');
