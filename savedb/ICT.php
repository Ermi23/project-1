<?php
            ...
            $sqlCheck = "SELECT * FROM incometax WHERE Datee = '$Month - $Year'";
...
$query = "INSERT INTO `incometax`(`መለያ_ኮድ`, `የሠራተኛው_ስም`, `የተቀጠሩበት_ቀን`, `ጠቅላላ_የትራንስፖርት_አበል`, `የስራ_ንግድ_ግብር_የሚከፈልበት_የትራንስፖርት_አበል`, `ትርፍ_ሰዓት_ክፍያ`, `ሌሎች_ጥቅማ_ጥቀሞች`, `ጠቅላላ_ግብር_የሚከፈልበት_ብር`, `የስራ_ግብር`, `የትምህርት_ወጪ_መጋራት`, `የተጣራ_ክፍያ`, `የሠራተኛ_ፊርማ`, datee) 
VALUES ('$empid','$names','01- $Month - $Year','$ca','$tca','$op','$other','$totalRowSum','$salaryIncomeTax','0.00','$net',' ','$Month - $Year')";
